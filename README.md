...
| 27 | `layers/27_entry_facilitators.json` | **Foreign market-entry facilitators in India** — the country-wise trade-promotion agencies & bilateral chambers that host events and B2B matchmaking to bring foreign firms into India (**27 bodies, 20 countries**): GTAI + Indo-German Chamber (AHK/IGCC), Swissnex + S-GE, UKIBC, JETRO, KOTRA, Business France + IFCCI, ITA/ICE, USIBC + AMCHAM, EBTC and more. URLs liveness-checked on build. Built by `scripts/build_layer27_entry_facilitators.py` |
