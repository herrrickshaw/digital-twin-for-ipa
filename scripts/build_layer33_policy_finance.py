...
CBG_GOBARDHAN = {
    ...
    "why_it_was_needed": ("CBG digestate/bio-slurry could not be sold as fertiliser "
                          ...
                          "it around SOIL CARBON not NPK — NPK floor dropped to "
                          "1.2 pct, organic carbon min 14 pct. Critics (Down To "
                          "Earth/CSE) note this also relaxes the organic-manure "
                          "quality norm."),
    "fom_spec_schedule_viii": {
        "total_NPK_min": "1.2 pct (N+P2O5+K2O; down from the old 5 pct)",
        "total_organic_carbon_min": "14 pct",
        "moisture_max": "30-70 pct",
        "c_to_n_ratio_max": 30,
        "sieve": "min 90 pct material through sieve",
        "pH": "6.5-8.4",
        "pathogens": "NIL",
        "heavy_metals_mg_per_kg": {"As": 10, "Cd": 5, "Cr": 300, "Cu": 50,
                                   "Hg": 0.15, "Ni": 50, "Pb": 100, "Zn": 1000},
        "source": "FCO Schedule VIII, as reproduced in a FACT procurement tender",
    },
    "lfom_spec_liquid": {
        "moisture": "90-97 pct (liquid — the key FOM-vs-LFOM differentiator)",
        "total_organic_carbon_min": "14 pct (on dry basis)",
        "total_NPK_min": "1.2 pct (N+P2O5+K2O, on dry basis)",
        "c_to_n_ratio_max": "< 20 (tighter than FOM's <= 30)",
        "pH": "6.5-8.0",
