...
EVENTS = [
    ...
    {"name": "InnoTrans", "sector": "Railways & Rail Transport (not yet a twin focus sector)", "scope": "Global (Berlin)",
     ...
     "value": ("HIGHEST of the global railway sources -- LIVE-VERIFIED 2026-08-22 by direct browser "
               "session: real company+address+hall/stand+segment+description per exhibitor, NO LOGIN "
               "required to browse (login only gates the separate 'Participants'/networking feature). "
               "Confirmed real sample: Knorr-Bremse, ABB Ltd. (Switzerland), 3M Deutschland, Aarsleff "
               "Rail A/S (Denmark), 4AI Systems (Australia). Backend is NOT a simple REST API (initial "
               "curl attempts hit a CloudFront/S3 SPA shell returning the same HTML for every path, "
               "and the app appears to route data through blob: URLs) -- full 3,082-company extraction "
               "needs a dedicated scroll-pagination session, not a one-shot fetch."),
     "last_verified": "2026-08-22", "recheck_recommended": "biennial; dedicated follow-up session for full pagination"},
    {"name": "IREE (International Railway Equipment Exhibition)", "sector": "Railways & Rail Transport (not yet a twin focus sector)", "scope": "India",
     ...
     "note": "16th edition, CII + Ministry of Railways, Asia's largest rail-sector event"},
     "value": "HIGH potential -- dedicated exhibitor-list PDF confirmed to exist (IREE-Exhibitors-List.pdf "
             "on ireeindia.com) but not yet downloaded/parsed",
     "last_verified": "2026-08-22", "recheck_recommended": "download and parse the exhibitor PDF"},
    {"name": "RailTrans Expo", "sector": "Railways & Rail Transport (not yet a twin focus sector)", "scope": "India",
     ...
     "value": "MEDIUM, unconfirmed -- dedicated event site exists, exhibitor-list page not yet checked",
     "last_verified": "2026-08-22", "recheck_recommended": "check railtransexpo.com for a list page"},
    ...
    {"name": "Light + Building", "sector": "Construction & Building Materials (not yet a twin focus sector)", "scope": "Global (Frankfurt)",
     ...
     "value": "CANDIDATE, not yet deep-dived -- Messe Frankfurt exhibitor search tools exist for all its shows",
    ...
    {"name": "ISH", "sector": "Construction & Building Materials (not yet a twin focus sector)", "scope": "Global (Frankfurt)",
     ...
     "value": "CANDIDATE, not yet deep-dived", "last_verified": "2026-08-22", "recheck_recommended": "deep-dive follow-up"},
    {"name": "Heimtextil", "sector": "Textiles & Apparel", "scope": "Global (Frankfurt)",
     ...
     "value": "CANDIDATE -- extends layer 39's textile coverage into home/contract textiles specifically",
     "last_verified": "2026-08-22", "recheck_recommended": "deep-dive follow-up"},
    {"name": "interpack", "sector": "Chemicals & Plastics", "scope": "Global (Düsseldorf)",
     ...
     "value": "CANDIDATE, flagged as a genuine sector gap by the scouting agent",
     "last_verified": "2026-08-22", "recheck_recommended": "deep-dive follow-up"},
    ...
    {"name": "wire & Tube Düsseldorf", "sector": "Specialty Steel & Metals", "scope": "Global (Düsseldorf)",
     "last_edition": {"year": 2026, "note": "wire, cable, tube & pipe manufacturing -- finished-goods, distinct from GIFA/METEC's raw-material focus; biennial"},
     "value": "CANDIDATE -- extends existing Steel & Metals coverage downstream", "last_verified": "2026-08-22", "recheck_recommended": "deep-dive follow-up"},
